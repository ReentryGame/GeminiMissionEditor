...
namespace GeminiV2.Mission
{
    public class MissionDescription
    {
        public enum SpacePrograms { Mercury = 0, Gemini = 1, Apollo = 2 };

        public SpacePrograms SpaceProgram { get; set; } = SpacePrograms.Gemini;
    ...
    public class ActivityStep
    {
        public enum StepGoal
        {
            ...
            AlignOrbit_PeValue1_ApValue2_IncValue3,
            EnterEVA,
            PickupBackpack
        };
    ...
    {
        public enum GoalType { ReachAltitude_Target1, ReachOrbit_PeTarget1_ApTarget2, Splashdown, CompleteActivityWithIndex_Target1, OrbitEarthNumTimes_Value1, DockWithAgena, RendezvousWithOtherGemini }
    ...
    {
        public enum MessageIsFrom { Commander, Pilot, MCC };
        ...
        public enum ExecuteAction
        {
            ...
            Orbit_TimeToTargetBurn_Value1Seconds,

            // 30 group - radio checks
            IsAtRadioStation_String1 = 30,
            SendDCSMessage_CoreValue1_DataValue2,
            Radio_SuccessRequestTargetBurn,
            Radio_TimeToTargetBurn_Value1,
            ...
            CheckComputerProgramRunning_ComputerMode,
            CheckTriggerButton,
            CheckGauge,
        ...
        public GaugeID GaugeId { get; set; }
        public GeminiOnBoardComputer.ComputerMode ComputerMode { get; set; }
